defmodule HelloWeb.MineController do
  ...
  def index(conn, _params) do
    ...
    #    render(conn, "index.html")
      ...
      json(conn,Miner.mine_next(Bitcoin.node_name(Enum.random(1..100))))
  end

  def get_keys(conn, _params) do
    value = Enum.reduce(1..100, [],fn x, acc ->
...
#    {amount, miner, wallet} = _params
  ...
  def blockchain(conn, params) do
    json(conn, Blockchain.valid?(Blockchain.get_blockchain()))
  end
end